...
if (getCourseById((int) $courseId) === false) {
    echo json_encode(['success' => false, 'message' => 'ไม่พบวิชาที่ต้องการ']);
    exit;
}

// Check if already enrolled
if (isEnrolled($userId, (int) $courseId)) {
    echo json_encode(['success' => false, 'message' => 'คุณลงทะเบียนวิชานี้แล้ว']);
    exit;
}

if (enrollCourse($userId, (int) $courseId)) {
